<header>
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #FFC38C;">
        <div class="container-fluid">
            <a href="index.php"> <img src="images/logo copy.png" id="image" style= "height: 60px; margin:0px 30px;"></a>

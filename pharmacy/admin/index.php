      ...
      <div class="row">
        <div class="card" style="width: 25rem;margin-bottom: 20px ;margin-right: 200px ;">
          ...
          <div class="card-body">
            ...
            <a href="orders.php" class="btn btn-primary"style="background-color: #FFC38C; border: 0">Go to orders page</a>
          </div>
        </div>
        <div class="card" style="width: 25rem;margin-bottom: 20px ;">
          ...
          <div class="card-body">
            ...
            <a href="products.php" class="btn btn-primary"style="background-color: #FFC38C; border: 0">Go to products page</a>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="card" style="width: 25rem;margin-top: 20px ;margin-right: 200px ;">
          ...
          <div class="card-body">
            ...
            <a href="customers.php" class="btn btn-primary" style="background-color: #FFC38C; border: 0">Go to customers page</a>
          </div>
        </div>
        <div class="card" style="width: 25rem;margin-top: 20px ;">
          ...
          <div class="card-body">
            ...
            <a href="admin.php" class="btn btn-primary"style="background-color: #FFC38C; border: 0">Go to admin page</a>
          </div>
        </div>
      </div>
    </main>
